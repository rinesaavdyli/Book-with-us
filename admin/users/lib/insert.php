...
include_once ($_SERVER['DOCUMENT_ROOT'].'/BookWithUs/book-with-us/Authentication/Controller/userscontroller.php');
...
if ( !empty($_POST)) {
        ...
        if(!$valid){
            ...
            $user = $u->createUser($username,$email,$password,$role);
